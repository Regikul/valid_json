...
- [~] Принимать схему без имени рядом, разведя регистрацию на две ступени.
  ...
  описано в README. Не выполнено: нормативный документ
  `okf/architecture/validator-resources-runtime.md` всё ещё описывает прежний
  фасад с обязательным именем.
